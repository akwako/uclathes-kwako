...
\vitaitem   {2022--2023}
		...
		For the study of measurement and mitigation of biases in automated English speaking assessment.}
...
\begin{table*}[htbp]
\centering
\caption{\label{wer_dscr} \raggedright Descriptive statistics of examinees subsampled for Study 1, overall and disaggregated by gender and L1.}
\small  % comment out this line if wanted bigger font size
...
\begin{table*}[ht]
\centering
\caption{\label{tab:nb_gend} \raggedright Performance of predicting gender for items 1–3, comparing off-the-shelf BERT to a Naïve Bayes classifier.}
\small  % comment out this line if wanted bigger font size
\begin{tabular}{lccccccccccccccccc}
\toprule
    & \multicolumn{8}{c}{\textbf{Grade Band 2–3}} & \multicolumn{1}{c}{ } & \multicolumn{8}{c}{\textbf{Grade Band 9–12}} \\
    \cline{2-9}
    \cline{11-18}
    & \multicolumn{2}{c}{\textbf{Acc.}} & & \multicolumn{2}{c}{\textbf{F1\textsubscript{m}}} & & \multicolumn{2}{c}{\textbf{F1\textsubscript{w}}} & \multicolumn{1}{c}{ } & \multicolumn{2}{c}{\textbf{Acc.}} & & \multicolumn{2}{c}{\textbf{F1\textsubscript{m}}} & & \multicolumn{2}{c}{\textbf{F1\textsubscript{w}}} \\
\cline{2-3}
\cline{5-6}
\cline{8-9}
\cline{11-12}
\cline{14-15}
\cline{17-18}
    \textbf{Item} & \textbf{B} & \textbf{N} & & \textbf{B} & \textbf{N} & & \textbf{B} & \textbf{N} & & \textbf{B} & \textbf{N} & & \textbf{B} & \textbf{N} & & \textbf{B} & \textbf{N} \\
    \midrule
...
3 & .560 & .559 & & .554 & .559 & & .556 & .559 & & .570 & .598 & & .543 & .588 & & .555 & .594 \\
    ...
    \end{tabular}
% {\raggedright \newline \newline  Note: "Acc." refers to accuracy, "r" to correlation, and "QWK" to quadratic weighted kappa. "H" refers to human-human comparisons (i.e. rater 2 compared to rater 1). The number of observations that were scored by two human raters ranged from 1,567–1641 for Grade Band 2–3, and from 1,254–1,293 for Grade Band 9–12. "B" refers to human-BERT comparisons (i.e. BERT compared to rater 1). The number of observations in the testing sets were 4,185 for Grade Band 2–3, and 3,306 for Grade Band 9–12. \par}
\caption*{\small Note: “Acc.” refers to accuracy, “F1\textsubscript{m}” to macro-average F1 score, and “F1\textsubscript{w}” to weighted-average F1 score. “B” refers to BERT, and “N” refers to “Naïve Bayes.” Performance was measured on the testing dataset.}
\end{table*}
...
\begin{table*}[ht]
\centering
\caption{\label{tab:nb_lang} \raggedright Performance of predicting L1 group for items 1–3, comparing off-the-shelf BERT to a Naïve Bayes classifier.}
\small  % comment out this line if wanted bigger font size
\begin{tabular}{lccccccccccccccccc}
\toprule
    & \multicolumn{8}{c}{\textbf{Grade Band 2–3}} & \multicolumn{1}{c}{ } & \multicolumn{8}{c}{\textbf{Grade Band 9–12}} \\
